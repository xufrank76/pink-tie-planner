    ...
    <>
      ...
      {pos && (
        <div style={{
          ...
          <div><span style={{ color: '#858080' }}>denominator: </span>{total} — core + major + minor/specializations (if any) + electives, counting shared courses once, not including pd or labs</div>
        </div>
      )}
    </>
  );
